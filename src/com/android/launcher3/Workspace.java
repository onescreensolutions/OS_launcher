        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN:
                    // Save the initial position when the touch starts
                    lastX = x;
                    lastY = y;
                    originalLeft = view.getLeft();
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    int newRight = newLeft + view.getWidth();
                    int newBottom = newTop + view.getHeight();
                    ...
                    // Ensure the view stays within the bounds of the home screen
                    if (newLeft >= 0 && newRight <= screenWidth && newTop >= 0 && newBottom <= screenHeight) {
                ...
                case MotionEvent.ACTION_UP:
                    // Handle any specific action upon release, if needed
                    break;
            }
            return true;
        }
...
//            }
            ...
            mQsb = LayoutInflater.from(getContext())
                .inflate(R.layout.workspace_screen, firstPage, false);
        }
...
//        CalendarView calander= new CalendarView(getContext());
        int x=4;
        int y=1;
        CellLayout.LayoutParams calenderparams = new CellLayout.LayoutParams(
            x, y,
            3, 1
        );
...
//        int x1=4;
//        int y1=1;
//        CellLayout.LayoutParams NotificationWidgetParams = new CellLayout.LayoutParams(
//            x1, y1,
//            2, 2
//        );
        ...
        int x1=4;
        int y1=2;
        CellLayout.LayoutParams calenderparams1 = new CellLayout.LayoutParams(
            x1, y1,
            3, 1
        );
...
//        View docstext=findViewById(R.id.docstext);
        View docsbtn = findViewById(R.id.docsImageView);
        docsbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getContext().getPackageManager().getLaunchIntentForPackage("com.google.android.apps.docs.editors.docs");
                if (intent != null) {
        ...
        View sheetsbtn = findViewById(R.id.sheetsImageView);
        sheetsbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getContext().getPackageManager().getLaunchIntentForPackage("com.google.android.apps.docs.editors.sheets");
                if (intent != null) {
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    getContext().startActivity(intent);
                }
        ...
        View slidesbtn = findViewById(R.id.slidesImageView);
        slidesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getContext().getPackageManager().getLaunchIntentForPackage("com.google.android.apps.docs.editors.slides");
                if (intent != null) {
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    getContext().startActivity(intent);
                }
        ...
        View classbtn = findViewById(R.id.classroomImageView);
        classbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getContext().getPackageManager().getLaunchIntentForPackage("com.google.android.apps.classroom");
                if (intent != null) {
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    getContext().startActivity(intent);
                }
        ...
        calenderparams1.topMargin=20;
        calenderparams1.bottomMargin=20;
        calenderparams1.rightMargin=450;

        View view1 = LayoutInflater.from(getContext()).inflate(R.layout.my_widget_2, firstPage, false);
        firstPage.addViewToCellLayout(view1, 0,0,calenderparams1,true);
        calenderparams1.canReorder=true;
        calenderparams.canReorder=true;
        View quizwizbtn = findViewById(R.id.quiwiz) ;
        quizwizbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://quizwiz.ai/";
        ...
        View Lhubbtn = findViewById(R.id.Lhub) ;
        Lhubbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://learning-hub.ai/";
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                if (intent.resolveActivity(getContext().getPackageManager()) != null) {
                    getContext().startActivity(intent);
                }
        ...
        View L_OSbtn = findViewById(R.id.L_OS) ;
        L_OSbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.onescreensolutions.com/en/l7-demo/";
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                if (intent.resolveActivity(getContext().getPackageManager()) != null) {
                    getContext().startActivity(intent);
                }
        ...
        textClock.setFormat12Hour("hh:mm aaaa\nEE, dd MMMM");

        textClock.setTextSize(50);
        textClock.setTextColor(Color.WHITE);// Example: Set the text size to 20sp

        CellLayout.LayoutParams clockLayoutParams = new CellLayout.LayoutParams(
            0, 1,
            2, 2
        );

        clockLayoutParams.leftMargin=250;
        clockLayoutParams.bottomMargin=250;
        clockLayoutParams.canReorder = false;

        CharSequence formatString = textClock.getFormat12Hour();

        SpannableString spannableString = new SpannableString(formatString);

        int smallTextSize = 50;

        int startDayOfWeek = formatString.toString().indexOf("EE, dd MMMM");
        int endDayOfWeek = startDayOfWeek + "EE, dd MMMM".length();

        spannableString.setSpan(new AbsoluteSizeSpan(smallTextSize), startDayOfWeek, endDayOfWeek, 0);


        textClock.setFormat12Hour(spannableString);

        textClock.setLayoutParams(clockLayoutParams);

        // Add OnClickListener to open clock settings
        textClock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open clock settings here
                Intent intent = new Intent(android.provider.Settings.ACTION_DATE_SETTINGS);
                getContext().startActivity(intent);
            }
        });

// Apply the modified layout parameters to the TextClock
        textClock.setLayoutParams(clockLayoutParams);

        // Add the TextClock widget to the home screen layout container
        if (!firstPage.addViewToCellLayout(textClock, 0, 3, clockLayoutParams, true)) {
            Log.e(TAG, "Failed to add TextClock to CellLayout");
        }

        ImageView iconView = new ImageView(getContext());
        iconView.setImageResource(R.drawable.guru_icon);

        CellLayout.LayoutParams iconLayoutParams = new CellLayout.LayoutParams( 0, 0, 1, 1); // Increase the size to 2x2 cells
        iconLayoutParams.canReorder = false;
        iconLayoutParams.isLockedToGrid = true;


        firstPage.addViewToCellLayout(iconView, 1, 1, iconLayoutParams, true); // Position it at (1, 1) for center placement
//        iconLayoutParams.rightMargin=400;
//        iconLayoutParams.bottomMargin=400;
        iconView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Launch the GuruApp
                Intent launchIntent = getContext().getPackageManager().getLaunchIntentForPackage("com.claryicon.guru.android");
...
//        ImageView iconView1 = new ImageView(getContext());
//        iconView1.setImageResource(R.drawable.onescreen_icon);
//
//        CellLayout.LayoutParams iconLayoutParams1 = new CellLayout.LayoutParams( 4, 0, 3, 1); // Increase the size to 2x2 cells
//        iconLayoutParams.canReorder = false;
//        iconLayoutParams1.isLockedToGrid=true;
//
//
//        firstPage.addViewToCellLayout(iconView1, 0, 1, iconLayoutParams1, true);
//
//        iconLayoutParams1.bottomMargin=100;
//        iconLayoutParams1.leftMargin=550;
//        iconView1.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if(counter%2==1)
//                {
//                    firstPage.removeView(view);
//                    firstPage.removeView(view1);
//                }
//                else
//                {
//                    firstPage.addViewToCellLayout(view, 1,1,calenderparams,true);
...
//        });//
////
        ImageView iconView2 = new ImageView(getContext());
// Set the icon image resource to your desired icon
        iconView2.setImageResource(R.drawable.guru_icon);

// Set layout parameters for the icon view
        CellLayout.LayoutParams iconLayoutParams2 = new CellLayout.LayoutParams( 8, 2, 1, 1); // Increase the size to 2x2 cells
        iconLayoutParams.canReorder = false;
        iconLayoutParams.isLockedToGrid = true; // Lock the icon to the grid

// Add the icon view to the first screen of the workspace
        firstPage.addViewToCellLayout(iconView2, 0, 1, iconLayoutParams2, true);
        iconLayoutParams2.setMargins(0,90,0,150);
        ...
        ImageView iconView3 = new ImageView(getContext());

        iconView3.setImageResource(R.drawable.guru_icon);

// Set layout parameters for the icon view
        CellLayout.LayoutParams iconLayoutParams3 = new CellLayout.LayoutParams( 9, 2, 1, 1); // Increase the size to 2x2 cells
        iconLayoutParams.canReorder = false;
        iconLayoutParams.isLockedToGrid = true; // Lock the icon to the grid
        iconLayoutParams3.setMargins(10,90,0,150);
// Add the icon view to the first screen of the workspace
        firstPage.addViewToCellLayout(iconView3, 0, 1, iconLayoutParams3, true);

        iconView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Launch the GuruApp
                Intent launchIntent = getContext().getPackageManager().getLaunchIntentForPackage("com.claryicon.guru.android");
        ...
        ImageView iconView4 = new ImageView(getContext());

        iconView4.setImageResource(R.drawable.guru_icon);

// Set layout parameters for the icon view
        CellLayout.LayoutParams iconLayoutParams4 = new CellLayout.LayoutParams( 10, 2, 1, 1); // Increase the size to 2x2 cells
        iconLayoutParams.canReorder = false;
        iconLayoutParams.isLockedToGrid = true; // Lock the icon to the grid

// Add the icon view to the first screen of the workspace
        firstPage.addViewToCellLayout(iconView4, 0, 1, iconLayoutParams4, true);
        iconLayoutParams4.setMargins(0,90,0,150);
        iconView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Launch the GuruApp
                Intent launchIntent = getContext().getPackageManager().getLaunchIntentForPackage("com.claryicon.guru.android");
...
//
//// Set layout parameters for the icon view
//        CellLayout.LayoutParams iconLayoutParams5 = new CellLayout.LayoutParams( 3, 3, 1, 1); // Increase the size to 2x2 cells
//        iconLayoutParams5.canReorder = false;
//        iconLayoutParams5.isLockedToGrid = true; // Lock the icon to the grid
//
//// Add the icon view to the first screen of the workspace
//        firstPage.addViewToCellLayout(iconView2, 0, 1, iconLayoutParams5, true);
//        iconLayoutParams5.setMargins(280,0,210,100);

        int containerSize = 1; // Size of the container (e.g., 2x2 cells)

        // Container 1 (Top-left)
        View container1 = new View(getContext());
        container1.setBackgroundColor(Color.WHITE);
        container1.setAlpha(0.5f);
        CellLayout.LayoutParams containerLayoutParams1 = new CellLayout.LayoutParams(8, 2, 1, 1);
        containerLayoutParams1.canReorder = false;
        firstPage.addViewToCellLayout(container1, 0, 0, containerLayoutParams1, true);
        containerLayoutParams1.setMargins(0, 50, 0, 50);


        // Container 3 (Bottom-left)
        View container3 = new View(getContext());
        container3.setBackgroundColor(Color.WHITE);
        container3.setAlpha(0.5f);
        CellLayout.LayoutParams containerLayoutParams3 = new CellLayout.LayoutParams(9, 2, containerSize, containerSize);
        containerLayoutParams3.setMargins(5, 50,5 , 50);
        containerLayoutParams3.canReorder = false;
        firstPage.addViewToCellLayout(container3, 0, 0, containerLayoutParams3, true);

        View container4 = new View(getContext());
        container4.setBackgroundColor(Color.WHITE);
        container4.setAlpha(0.5f);
        CellLayout.LayoutParams containerLayoutParams4 = new CellLayout.LayoutParams(10, 2, containerSize, containerSize);
        containerLayoutParams4.setMargins(0, 50, 0, 50);
        containerLayoutParams4.canReorder = false;
        firstPage.addViewToCellLayout(container4, 0, 0, containerLayoutParams4, true);
