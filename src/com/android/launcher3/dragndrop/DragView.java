...
public abstract class DragView<T extends Context & ActivityContext> extends FrameLayout {
    ...
    public DragView(T activity, View content, int width, int height, int registrationX,
        ...
        // Create a custom view for the red square
//        View redSquare = new View(getContext());
//        redSquare.setBackgroundColor(Color.RED);
//        int squareSize = 50; // Adjust the size according to your needs
//        int squareX = registrationX - squareSize / 2;
//        int squareY = registrationY - squareSize / 2;
//        LayoutParams squareLayoutParams = new LayoutParams(squareSize, squareSize);
//        squareLayoutParams.leftMargin = squareX;
//        squareLayoutParams.topMargin = squareY;
//        addView(redSquare, squareLayoutParams);
